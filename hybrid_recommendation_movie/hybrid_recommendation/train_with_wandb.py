...
def parse_args():
    ...
    # Data arguments
    parser.add_argument('--ratings-path', type=str, default=str(Path(__file__).parent.parent.parent / 'movies' / 'cinesync' / 'ml-32m' / 'ratings.csv'),
                       help='Path to ratings CSV file')
    parser.add_argument('--movies-path', type=str, default=str(Path(__file__).parent.parent.parent / 'movies' / 'cinesync' / 'ml-32m' / 'movies.csv'),
